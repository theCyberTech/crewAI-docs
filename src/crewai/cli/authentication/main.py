...
class AuthenticationCommand:
    ...
    def _get_device_code(self) -> Dict[str, Any]:
        ...
        response = requests.post(url=self.DEVICE_CODE_URL, data=device_code_payload, timeout=60)
    ...
    def _poll_for_token(self, device_code_data: Dict[str, Any]) -> None:
        ...
        while True and attempts < 5:
            response = requests.post(self.TOKEN_URL, data=token_payload, timeout=60)
